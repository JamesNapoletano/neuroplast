...
- Existing knowledge in `/brain/learning/`

## Outputs
- New or updated markdown note(s) in `/brain/learning/` categorized by topic
...
3. Determine the best category path under `/brain/learning/`.
...
## Failure Handling
- If `/brain/learning/` is missing, create it before writing notes.
