...
const { getLcpBridgeDirectories, getLcpBridgeFiles, getLcpTemplateFiles } = require("../lcp/bridge");
...
const lcpTemplateFiles = getLcpTemplateFiles();
